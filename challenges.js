...
const challenges = [
  ...
  for (let i = 0; i < nums.length; i++) {
    ...
    complexity: `// Time: O(n)
// Space: O(n)`,
    explanation: 'Use a hash map to store each number’s index. For each element, check if its complement (target−num) exists in the map.',
...
// Space: O(max(m, n))`,
    explanation: 'Traverse both lists, sum corresponding digits + carry, build new nodes, propagate carry.',
  ...
  return maxLen;
    ...
    complexity: `// Time: O(n)
// Space: O(min(n, m))`,
    explanation: 'Use a sliding window and a set to maintain unique characters, expand right and contract left on duplicates.',
...
// Space: O(1)`,
    explanation: 'Binary search partition on the smaller array to split left/right halves equally, compute median from edge values.',
...
// Space: O(1)`,
    explanation: 'Expand around each center (odd and even) to find max palindrome, track global start/end.',
  ...
  },
  {
    ...
    difficulty: 'easy',
    description: 'Find the maximum sum of a contiguous subarray of size k in the array.',
  ...
  return maxSum;
    ...
    complexity: `// Time: O(n)
// Space: O(1)`,
    explanation: 'Use a fixed-size sliding window: sum first k elements, then slide by adding new and removing old.',
  ...
  return res;
    ...
    complexity: `// Time: O(n)
// Space: O(k)`,
    explanation: 'Maintain a decreasing deque of indices; front is max. Pop smaller elements before adding new.',
  ...
  },
  {
    ...
    difficulty: 'medium',
    description: 'Given n non-negative integers, find two lines that together with x-axis form a container containing the most water.',
  ...
  return maxA;
    ...
    complexity: `// Time: O(n)
// Space: O(1)`,
    explanation: 'Two pointers from ends, move the shorter inward to possibly find taller boundary.',
  ...
  return water;
    ...
    complexity: `// Time: O(n)
// Space: O(1)`,
    explanation: 'Maintain left/right max boundaries; trap water on the side with shorter current height.',
  ...
  return minLen === Infinity ? 0 : minLen;
    ...
    complexity: `// Time: O(n)
// Space: O(1)`,
    explanation: 'Expand right to increase sum, then contract left while sum ≥ target to find minimal window.',
  ...
  },
  {
    ...
    difficulty: 'medium',
    description: 'Count the total number of continuous subarrays whose sum equals k.',
  ...
  return count;
    ...
    complexity: `// Time: O(n)
// Space: O(n)`,
    explanation: 'Prefix sum + hash map of frequencies: for each sum, look up (sum−k).',
  ...
  },
  {
    ...
    difficulty: 'easy',
    description: 'Given an integer array, return sum of elements between indices i and j inclusive.',
...
// Space: O(1)`,
    explanation: 'Standard half-interval search; compare mid to target, move pointers.',
  ...
  },
  {
    ...
    difficulty: 'medium',
    description: 'Search a target in a rotated sorted array without duplicates in O(log n).',
  ...
  return -1;
    ...
    complexity: `// Time: O(log n)
// Space: O(1)`,
    explanation: 'Determine which half is sorted, then binary search that half if target lies within.',
...
// Space: O(n)`,
    explanation: 'Sort by start, then either merge with last or push new interval.',
...
// Space: O(1)`,
  ...
  return null;
    ...
    complexity: `// Time: O(n)
// Space: O(1)`,
    explanation: 'Use Floyd’s cycle detection; reset one pointer to head to find entry point.',
...
// Space: O(m+n) recursion`,
  ...
  },
  {
    ...
    difficulty: 'easy',
    description: 'Check if an input string of brackets is valid (closed in correct order).',
    tags: ['Stack', 'String'],
...
// Space: O(n)`,
  ...
  return stack[0];
    ...
    complexity: `// Time: O(n)
// Space: O(n)`,
    explanation: 'Use stack: push numbers, on operator pop two, compute, push result.',
  ...
  },
  {
    ...
    difficulty: 'easy',
    description: 'Each time you can climb 1 or 2 steps. How many distinct ways to reach n?',
...
// Space: O(1)`,
  ...
  },
  {
    ...
    difficulty: 'medium',
    description: 'Return all possible letter combos that the number could represent.',
...
// Space: O(1)`,
    explanation: 'Backtracking with row/col/box constraints, fill empty cells depth-first.',
  ...
  for (let i = m-1; i >= 0; i--) {
    ...
    complexity: `// Time: O(m*n)
// Space: O(1)`,
    explanation: 'Use first row/column as markers, then zero cells in reverse to avoid overwriting markers early.',
  ...
  complexity: `// Time: O(n)  
// Space: O(k)`,
  explanation: 'Tokenize on whitespace, lowercase, then tally counts in an object.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Recursively flatten any depth of nested arrays into one flat array.',
  ...
  complexity: `// Time: O(n)  
// Space: O(n)`,
  explanation: 'Use recursion + reduce: when an element is an array, flatten it, otherwise append it.',
...
},
{
  ...
  complexity: `// Time: O(n²)  
// Space: O(n²)`,
  explanation: 'DP on substrings: expand ends if match; otherwise take max of dropping one end.',
...
},
{
  ...
  complexity: `// Time: O(1)  
// Space: O(1)`,
  explanation: 'Cancel previous timeout on each call; schedule new invocation after delay.',
...
},
{
  ...
  complexity: `// Time: O(n)  
// Space: O(n)`,
  explanation: 'Push opens to stack; on closing bracket check top matches corresponding opener.',
  link: 'https://leetcode.com/problems/valid-parentheses/'
},
{
  id: 31,
...
// Space: O(n)`,
  explanation: 'Cache results on first call, reuse on subsequent identical args.',
...
// Space: O(1) (output doesn’t count)`,
  explanation: 'Two passes: accumulate product from left and right into res array.',
...
// Space: O(V)`,
  explanation: 'DFS with map to avoid revisiting; clone nodes & their edges recursively.',
...
},
{
  ...
  complexity: `// Time: O(1)  
// Space: O(capacity)`,
  explanation: 'Use Map’s insertion order: delete + reinsert moves key to “most recent.”',
...
},
{
  ...
  complexity: `// Time: O(n)  
// Space: O(1)`,
  explanation: 'Iterate schema rules, check required fields and types against object.',
...
},
{
  ...
  difficulty: 'easy',
  description: 'Return inorder traversal of a binary tree (recursive & iterative).',
  tags: ['Trees', 'DFS'],
  companies: ['Google', 'Microsoft'],
  code: `// Recursive:
...
function inorderIter(root) {
  ...
  complexity: `// Time: O(n)  
// Space: O(n)`,
  explanation: 'Classic DFS: recurse or use stack to simulate call stack for inorder.',
...
// Space: O(n + m)`,
  explanation: 'Expand right, track counts; contract left when all needed chars matched.',
...
},
{
  ...
  complexity: `// Time: O(n)  
// Space: O(n)`,
  explanation: 'Loop through schema.fields to generate inputs and labels dynamically.',
...
},
{
  ...
  complexity: `// Time: O(n log n)  
// Space: O(n)`,
  explanation: 'Sort by start, then merge or append based on overlap with last interval.',
  link: 'https://leetcode.com/problems/merge-intervals/'
},
{
  id: 45,
...
// Space: O(total chars)`,
  explanation: 'Use trie storing hot counts at each node; update and query top 3 suggestions.',
...
},
{
  ...
  complexity: `// Time: O(V+E)  
// Space: O(V)`,
  explanation: '0=unseen,1=visiting,2=done; a back-edge to 1 indicates a cycle.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'In an array where a[i] ≠ a[i+1], find any peak (local maximum) in O(log n).',
  tags: ['Binary Search', 'Divide and Conquer'],
...
},
{
  ...
  difficulty: 'medium',
  description: 'Build a prefix tree for insert, search, and startsWith operations.',
...
},
{
  ...
  complexity: `// Time: O(n)  
// Space: O(n)`,
  explanation: 'Recurse into nested objects, collect keys that differ with old→new values.',
...
},
{
  ...
  difficulty: 'easy',
  description: 'Given prices array, maximize profit with one buy-sell transaction.',
  tags: ['Arrays', 'Greedy'],
  ...
  complexity: `// Time: O(n)  
// Space: O(1)`,
  explanation: 'Track minimum price so far; compute max difference at each step.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Store each number’s index in a map; lookup complement in one pass.',
  link: 'https://leetcode.com/problems/two-sum/'
},
{
  id: 52,
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Bucket-sort frequencies by count and gather top k from highest bucket.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(h)`,
  explanation: 'Recursively enforce valid range for each node’s value in subtrees.',
...
function deserialize(data) {
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Preorder traversal with null markers for unambiguous reconstruction.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Wrap each promise; collect results by index; resolve when all settle.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Use recursion with WeakMap to handle circular refs and clone nested structures.',
...
// Space: O(n)`,
  explanation: 'Maintain map of event names to listener arrays; invoke or remove as needed.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Traverse binary tree levels in alternating left-to-right and right-to-left order.',
  tags: ['Trees', 'BFS'],
...
},
{
  ...
  title: 'Word Search',
  difficulty: 'hard',
  description: 'Given grid and word, check if word exists by traversing adjacent cells.',
  tags: ['Backtracking', 'Matrix'],
  companies: ['Google'],
...
// Space: O(L)`,
  explanation: 'Backtracking with marking visited cells and exploring 4 directions.',
...
},
{
  ...
  title: 'N-Queens',
  difficulty: 'hard',
  description: 'Place N queens on N×N board so no two attack each other; return all solutions.',
  tags: ['Backtracking'],
  companies: ['Amazon', 'Google'],
  ...
  complexity: `// Time: O(n!)
// Space: O(n^2)`,
  explanation: 'Backtrack row by row, track columns and diagonals to prune conflicts.',
...
},
{
  ...
  complexity: `// Time: O(4^n / sqrt(n))
// Space: O(n)`,
  explanation: 'Backtrack adding "(" or ")" while maintaining valid prefix constraints.',
  link: 'https://leetcode.com/problems/generate-parentheses/'
},
{
  id: 62,
  ...
  complexity: `// Time: O(n)
// Space: O(k)`,
  explanation: 'Maintain indices in deque in decreasing order; front is window max.',
  link: 'https://leetcode.com/problems/sliding-window-maximum/'
},
{
  id: 63,
  ...
  complexity: `// Time: O(n)
// Space: O(1)`,
  explanation: 'Two-pointer scan, accumulate water by tracking left/right max heights.',
  link: 'https://leetcode.com/problems/trapping-rain-water/'
},
{
  id: 64,
...
// Space: O(n)`,
  explanation: 'Balance two heaps so their sizes differ by ≤1; median from tops.',
...
},
{
  ...
  difficulty: 'hard',
  description: 'Build a simplified Twitter: post tweets, follow, and get news feed.',
...
// Space: O(n + m)`,
  explanation: 'Map tweets per user with timestamp; merge-sort top entries for feed.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(1)`,
  explanation: 'Maintain a candidate and cancel out pairs of different elements.',
...
// Space: O(n k)`,
  explanation: 'Sort each string as key; collect originals in a hash map by sorted key.',
...
},
{
  ...
  complexity: `// Time: O(m·n)
// Space: O(m·n)`,
  explanation: 'Traverse grid; on finding land, flood-fill to mark entire island visited.',
...
},
{
  ...
  title: 'Word Ladder',
  difficulty: 'hard',
  description: 'Transform beginWord to endWord by changing one letter at a time.',
  tags: ['BFS', 'Strings'],
  companies: ['Amazon', 'Microsoft'],
...
// Space: O(N·L)`,
  explanation: 'BFS through one-letter transformations, tracking distance until target.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Design singly linked list with get, addAtHead, addAtTail, addAtIndex, deleteAtIndex.',
...
// Space: O(n)`,
  explanation: 'Dummy head simplifies insert/delete; traverse to predecessor by index.',
...
},
{
  ...
  title: 'LFU Cache',
  difficulty: 'hard',
  description: 'Design a cache that evicts least-frequently used key in O(1).',
  tags: ['Design', 'HashMap', 'DoublyLinkedList'],
  companies: ['Google', 'Facebook'],
  code: `class LFUCache {
  ...
  complexity: `// Time: O(1)
// Space: O(capacity)`,
  explanation: 'Track frequency lists and minimum frequency to evict LFU key in O(1).',
...
},
{
  ...
  difficulty: 'hard',
  description: 'Evaluate string expression with +, -, parentheses, and spaces.',
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Use stack for result and sign at parentheses; accumulate numbers on the fly.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Find order to finish courses given prerequisites or return empty if cycle.',
  ...
  complexity: `// Time: O(V + E)
// Space: O(V + E)`,
  explanation: 'Use Kahn’s algorithm: BFS on zero indegree nodes to build topological order.',
...
},
{
  ...
  title: 'Word Break',
  difficulty: 'medium',
  description: 'Determine if s can be segmented into a sequence of dictionary words.',
  tags: ['DP', 'Strings'],
  companies: ['Microsoft', 'Amazon'],
  ...
  complexity: `// Time: O(n^2)
// Space: O(n)`,
  explanation: 'dp[i] is true if prefix [0,i) can be segmented; check all cuts using a set.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(1)`,
  explanation: 'Sliding window of size p.length; track counts and valid matches.',
...
// Space: O(k)`,
  explanation: 'Push heads into min-heap; repeatedly extract smallest and enqueue its next.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Use a queue for BFS; process nodes level by level collecting values.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(1)`,
  explanation: 'Split list, reverse second half, then merge two halves alternately.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Group files with identical content given directory info strings.',
  tags: ['HashMap', 'Strings'],
  companies: ['Google'],
...
// Space: O(n·k)`,
  explanation: 'Parse each path; map file content to full paths; filter duplicates.',
...
},
{
  ...
  complexity: `// Time: O(m·n)
// Space: O(1)`,
  explanation: 'Use four boundaries and traverse top, right, bottom, left in loops.',
...
// Space: O(n)`,
  explanation: 'Backtrack building paths and marking used elements until full length.',
...
// Space: O(n)`,
  explanation: 'Backtrack by including or excluding each element, collect all paths.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Find unique combinations that sum to target with unlimited repeats.',
...
// Space: O(target/min)`,
  explanation: 'Backtrack by adding candidates and pruning when sum exceeds target.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Maintain a stack of indices with increasing heights; compute areas on pop.',
...
},
{
  ...
  complexity: `// Time: O(1)
// Space: O(1)`,
  explanation: 'Use sets to track seen numbers in each row, column, and 3×3 box.',
...
},
{
  ...
  complexity: `// Time: O(log n)
// Space: O(1)`,
  explanation: 'Binary search by determining which half is sorted and where target lies.',
  link: 'https://leetcode.com/problems/search-in-rotated-sorted-array/'
},
{
  id: 91,
  title: 'Jump Game',
  difficulty: 'medium',
  description: 'Determine if you can reach last index given max jump lengths.',
  tags: ['Greedy'],
  companies: ['Microsoft', 'Amazon'],
  ...
  complexity: `// Time: O(n)
// Space: O(1)`,
  explanation: 'Track furthest reachable index; fail if current index exceeds it.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(1)`,
  explanation: 'Greedy layers: extend farthest reachable and increase jump count at boundary.',
...
},
{
  ...
  title: 'Unique Paths',
  difficulty: 'medium',
  description: 'Count paths from top-left to bottom-right in grid moving only right or down.',
  tags: ['DP', 'Math'],
  companies: ['Google', 'Facebook'],
  ...
  complexity: `// Time: O(m·n)
// Space: O(n)`,
  explanation: 'DP in-place: dp[j] holds number of ways to reach cell in current row.',
...
},
{
  ...
  complexity: `// Time: O(m·n)
// Space: O(n)`,
  explanation: 'DP in one array; zero out when obstacle, accumulate from left otherwise.',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'DP where dp[i] = ways ending at i; consider one- and two-digit decodings.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Transform tree in-place to a right-skewed linked list by preorder.',
  tags: ['Trees', 'DFS'],
  companies: ['Google', 'Amazon'],
  ...
  complexity: `// Time: O(n)
// Space: O(n) (recursion)`,
  explanation: 'Reverse preorder: recurse right, left, rewire right pointer to previous node.',
...
},
{
  ...
  difficulty: 'medium',
  description: 'Determine if array can be split into two subsets with equal sum.',
  tags: ['DP', 'Knapsack'],
  companies: ['Amazon', 'Google'],
...
// Space: O(sum)`,
  explanation: '0/1 knapsack: can we fill capacity sum/2 using elements once?',
...
},
{
  ...
  complexity: `// Time: O(n)
// Space: O(n)`,
  explanation: 'Append non-overlapping, merge overlaps with newInterval, then rest.',
...
},
{
  ...
  complexity: `// Time: O(n^2)
// Space: O(1)`,
  explanation: 'Expand around each center (odd and even) counting valid palindromes.',
...
function renderChallenge(c) {
  const tagSpans = c.tags
    .map(t => `<span class="tag px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded text-xs">${t}</span>`)
    .join('\n                ');
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6 challenge-card border border-gray-200 dark:border-gray-700"
     data-id="${c.id}" data-category="${c.tags[0] || ''}" data-company="${c.companies[0] || ''}">
  <div class="p-6">
    <div class="flex justify-between items-start">
      <div>
        <div class="flex items-center gap-2 mb-1">
          <h3 class="text-xl font-semibold text-gray-800 dark:text-white challenge-title">${c.id}. ${c.title}</h3>
          <span class="text-xs px-2 py-1 rounded-full difficulty-${c.difficulty}">${c.difficulty.charAt(0).toUpperCase() + c.difficulty.slice(1)}</span>
        </div>
      ...
      <div class="flex items-center gap-2">
        <button class="p-2 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 bookmark-btn" data-id="${c.id}" title="Bookmark"><i class="far fa-bookmark"></i></button>
        <button class="p-2 text-gray-400 hover:text-green-600 dark:hover:text-green-400 mark-complete-btn" data-id="${c.id}" title="Mark as Complete"><i class="far fa-check-circle"></i></button>
      </div>
    </div>
    <div class="mt-4 flex justify-between items-center">
      <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400"><i class="fas fa-building"></i><span>${companySpan}</span></div>
      <button class="solution-toggle-btn flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-500 font-medium" data-id="${c.id}">
    ...
    <div class="solution-toggle mt-4 hidden">
      <div class="solution-content bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
        ...
        <pre class="bg-gray-800 dark:bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm"><code>${c.code}
...
${c.complexity}</code></pre>
        ...
        <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
          ...
          <div class="flex flex-wrap gap-2">
            <a href="${c.link}" class="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-lg text-sm flex items-center gap-2" target="_blank">
...
console.log('✅ output.html generated with', challenges.length, 'challenge cards.');
